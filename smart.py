...
logger.setLevel(logging.DEBUG)  # You can make this configurable via env var
...
logger.debug(f"Using venv path: {venv_path}")
...
try:
    ...
    from app.core.card_utils import config
    from app.db import init_db
except ImportError as e:
    logger.error(f"Import error: {e}")
    print("Ensure all required modules are installed and accessible.")
    sys.exit(1)
...
# Add a logging middleware to track all requests
